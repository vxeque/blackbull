...
const motoRepartidor = require("../../assets/images/moto.png");
const imgCasa = require("../../assets/images/casa.png");

export default function deliveryData() {
    const imgTelephone = require("../../assets/images/telephone.png");
    const imgMesagge = require("../../assets/images/Mesagge.png");
  const imgUsers = require("../../assets/images/users.png");
    const mas = require("../../assets/images/mas.png");

  //   const [apiDealers, setApiDealers] = useState("");
    const [propina, setPropina] = useState(10.0);
    const [order, setOrder] = useState("");

  //   const urlApiDealers = `https://${urlApi()}/delivery/api/v1/dealers/${dataclient.getDealers()}`;
  ...
  return (
    <View style={style.styleContedMain}>
      ...
      <View style={style.styleContedInfo}>
        ...
        {/* name of dealers */}
        <View>
          <Text style={style.styleFontName}>alberto</Text>
          <Text>Tu repartidor BlackBull</Text>
        </View>
